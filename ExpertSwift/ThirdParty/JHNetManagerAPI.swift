...
class JHNetManagerAPI: NSObject {
    ...
    func JHRequestData(_ type : MethodTypes, URLString : String, para : [String : String]? = nil,ShowHUD:Bool, finishedCallback :  @escaping (_ result : Any?) -> ()) {
        if ShowHUD {
